import { nearestAccentPresetIndex, type AccentPresetIndex } from '../review/reviewDarkAccent'
...
/**
 * RGBA buffer, row-major (e.g. canvas ImageData or `jpeg-js` decode).
 * Returns closest accent preset index, or null if nothing saturated enough.
 */
export function presetIndexFromImageData(
  data: Uint8Array | Uint8ClampedArray,
  width: number,
  height: number,
): AccentPresetIndex | null {
